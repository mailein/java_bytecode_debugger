...
* @author Lisa Detzler
*/
public abstract class IntChannel extends Channel {
	...
	* @author Lisa Detzler
	*/
	abstract public Integer handleSelect(Work w);
	...
	* @author Lisa Detzler
	*/
	abstract public Integer selectPut(Object exp, PseuCoThread thread);
	...
	* @author Lisa Detzler
	*/
	abstract public Integer selectTake(PseuCoThread thread);
