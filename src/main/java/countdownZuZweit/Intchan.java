...
/**
* Represents PseuCo's buffered <tt>intchan</tt>.
*
* @author Lisa Detzler
*/
public class Intchan extends IntChannel {
	...
	*/
	...
	/**
	* Creates a new int channel with the spcified capacity.
	*
	* @param channelSize The capacity of the channel.
	* @author Lisa Detzler
	*/
	public  Intchan(int channelSize) {
		this.channel = new ArrayBlockingQueue<Integer>(channelSize);
		Handshake.lock.lock();
